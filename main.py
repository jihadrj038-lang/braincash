...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"হ্যালো {user.first_name}! 👋\n**GlobalNumBD** বোটে আপনাকে স্বাগতম। নিচে থেকে সার্ভিস বেছে নিন:",
...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'buy_number':
        ...
        await query.edit_message_text(
            "👨‍💻 যেকোনো প্রয়োজনে অ্যাডমিনের সাথে যোগাযোগ করুন:\nঅ্যাডমিন আইডি: @jihad1171",
...
# --- ইউজার মেসেজ রিসিভ ও অ্যাডমিনকে নোটিফিকেশন ---
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if pending_order:
        ...
        admin_text = (
            ...
            f"📌 **কাস্টমারকে নম্বর দিতে লিখে পাঠান:**\n`/sendnum {user.id} <আপনার_নম্বর>`"
        )
        await context.bot.send_message(chat_id=ADMIN_ID, text=admin_text, parse_mode='Markdown')
        
        await update.message.reply_text("✅ আপনার পেমেন্ট তথ্য জমা নেওয়া হয়েছে! অ্যাডমিন ভেরিফাই করে দ্রুত আপনাকে নম্বর পাঠিয়ে দেবে।")
        context.user_data['pending_order'] = None
    else:
        await update.message.reply_text("অর্ডার শুরু করতে /start লিখে প্রেস করুন।")

# --- অ্যাডমিন কমান্ড: কাস্টমারকে নম্বর পাঠানো ---
async def send_number(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        msg = f"🎉 **আপনার অর্ডারকৃত নম্বর:**\n`{number_to_send}`\n\nOTP কোডের জন্য অপেক্ষা করুন, আসা মাত্রই পাঠিয়ে দেওয়া হবে।"
